...
const fs = require('fs');
const schemaPath = path.join(__dirname, './../schema/studentSchema.json');
const Student = require('./../databaseModels/student')(schemaPath);
const StudentHistory = require('./../databaseModels/studentHistory')(schemaPath);
...
function writeToSchemaFile(path, data, callback) {
    fs.writeFile(path, JSON.stringify(data), (err) => {
        ...
        Student.refreshModel();
        StudentHistory.refreshModel();
